 ...
 * array
 */
public class SwitchingArrayBaker extends ClassLoader {

	public RunnableConsumer bake(int maxUnroll) {
		try {
			if (maxUnroll < 1) {
				throw new IllegalArgumentException("Max unroll must be an element of Z+");
			}
